...
* Be careful when designing such lists because they can result in name conflicts, creating problems.
...
For a basic example about a devfile with an associated Kubernetes or OpenShift list, see link:https://github.com/redhat-developer/devfile/tree/master/samples/web-nodejs-with-db-sample[web-nodejs-with-db-sample].
