...
[NOTE]
====
* Set your project to `/my-module/` to create only the root `my-module` directory along with its content.
...
** The trailing slash indicates that only directories and their content with the given name are created.
