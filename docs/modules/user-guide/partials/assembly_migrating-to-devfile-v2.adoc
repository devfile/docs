...
* New metadata: `version`, go to its link:https://github.com/che-incubator/devworkspace-api/issues/10[GitHub issue].
* New mandatory metadata for plugins, go to its link:https://github.com/devfile/api/issues/31[GitHub issue].
