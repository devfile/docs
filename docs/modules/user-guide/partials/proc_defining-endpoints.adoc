...
* `protocol`: For public endpoints, the protocol is a hint to the devfile consumer on how to construct the URL for the endpoint access. Typical values are `http`, `https`, `ws`, `wss`.
