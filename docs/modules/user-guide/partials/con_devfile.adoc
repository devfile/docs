...
You can use devfiles to automate and simplify your development process. With devfiles, you record the instructions for configuring and running your software build environment as a YAML-formatted text file. Then, optionally, you can distribute those instructions to other software build tools and IDEs that support devfiles. Finally, to automatically configure and build a running application from a development project, you run the devfile instructions. You can also use devfiles to provide consistent software build processes across different languages and tools. 
