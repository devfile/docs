...
source:
    git:
      remotes: https://github.com/eclipse/che.git
      startPoint: master           <1>
      tag: 7.2.0
      commitId: 36fe587
      branch: master
...
projects:
  ...
  - name: my-project
    source:
      git:
        remotes: https://github.com/my-org/project.git
        branch: develop
----
...
projects:
  - name: my-go-project
    ...
    git:
      remotes: https://github.com/acme/my-go-project.git
components:
  - name: go
    container:
      image: golang
...
projects:
  - name: my-maven-project
    ...
    git:
      remotes: https://github.com/acme/my-maven-project.git
components:
  - name: maven
    container:
      image: eclipe/maven-jdk8:latest
...
projects:
  - name: petclinic
    git:
      remotes: 'https://github.com/che-samples/web-java-spring-petclinic.git'
attributes:
